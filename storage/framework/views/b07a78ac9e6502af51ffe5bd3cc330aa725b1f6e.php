      ...
      <div class="card shadow">
        <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="author" placeholder="Author" value="<?php echo e(old('author')); ?>" required>
           </div>
             <div class="form-group">
            ...
            -->
              ...
              <div class="form-group">
                ...
                <textarea name="body" required><?php echo old('body', $body ?? ''); ?></textarea>
                <!--
                <textarea name="body" id="summernote" required><?php echo old('body', $body ?? ''); ?></textarea>-->
              </div>
              <div class="form-group">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Yovi\Kuliah\Lomba\farm_culture\resources\views/admin/article/create.blade.php ENDPATH**/ ?>