...
<nav class="navbar navbar-expand-lg fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#">
        <img src="<?php echo e(asset('assets/icons/navbar-logo.png')); ?>" width="120px" alt="">
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            <a class="nav-link <?php echo e(request()->is('articles') ? 'active' : ''); ?>" href="<?php echo e(route('articles')); ?>">News</a>
          </li>
          <li class="nav-item">
          ...
          <div class="box-container">
            <div class="form-group">
              ...
              <button type="submit" class="btn-sm bg-transparent">
                <img src="<?php echo e(asset('assets/icons/search.png')); ?>" width="12px" alt="seacrh">
              </button>
            </div>
          </div>
        </form>-->
        <!--
        <form action="<?php echo e(route('search')); ?>" method="GET" class="d-none d-flex form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="form-group">
        ...
        <!--<div class="box-container">
          <table class="element-container">
            <tr>
              ...
              <td>
                <a href="#">
                  <img src="<?php echo e(asset('assets/icons/search.png')); ?>" width="14px" alt="seacrh">
                </a>
              </td>
            </tr>
          </table>
  ...
  <?php /**PATH D:\Yovi\Kuliah\Lomba\farm_culture\resources\views/frontend/partials/navbar.blade.php ENDPATH**/ ?>