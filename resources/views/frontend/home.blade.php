...
<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    @foreach ($articles as $article)
      @if ($article->title == 'Agriculture 5.0: Artificial Intelligence, Iot & Machine Learning')
        <div class="carousel-item active" style="background-image: url(assets/pictures/header-image-1.jpg);">
          <div class="header-content container">
            ...
            <button type="button" class="btn btn-success mt-4"><a class="text-white text-decoration-none" href="{{ route('detail', $article->slug)}}">Read more</a></button>
          </div>
        </div>
      @elseif ($article->title == 'Agriculture’s Digital Future')
      ...
      @elseif ($article->title == 'Agriculture Sector, Industrial Era 4.0 And Society 5.0')
...
@foreach ($articles as $article)
  @if ($article->title == 'The Art Of Agriculture')
    <section class="highlighted-content container-fluid p-0">
      <div class="row m-0">
        <div class="col-6 d-none d-lg-block p-0 m-0">
          <img src="{{Storage::url($article->image)}}" class="figure-img img-fluid p-0" alt="...">
        </div>
        <div class="col-12 m-0 pt-5 col-lg-6 d-flex justify-content-center align-items-center">
          <div class="feature-sub-content">
            ...
            <h1 class="mb-3">{{$article->title}}</h1>
            <p class="sub-title mb-3">{!!Str::words($article->body,16,'...')!!}</p>
            <button type="button" class="btn bg-white mt-4"><a class="text-dark text-decoration-none" href="{{ route('detail', $article->slug)}}">Read more</a></button>
          </div>
        </div>
      </div>
    </section>
...
@endforeach
    ...
    <section class="highlighted-content container-fluid p-0">
      <div class="row m-0">
        <div class="col-6 d-none d-lg-block p-0 m-0">
          <img src="{{asset('assets/pictures/Photo by no one cares on Unsplash.jpg')}}" class="figure-img img-fluid p-0" alt="...">
        </div>
        <div class="col-12 m-0 pt-5 col-lg-6 d-flex justify-content-center align-items-center">
          <div class="feature-sub-content">
            <h6>Feature</h6>
    ...
    <section class="feature-news mt-5">
      <div class="container">
        @foreach ($articles as $article)
            @if ($article->title == 'Unlocking Indonesian Agriculture’s Digital Future' )
              <div class="row reveal">
                ...
                <div class="col-8 col-lg-6 m-0 d-none d-lg-block d-flex justify-content-end">
                  <img src="{{Storage::url($article->image)}}" width="540px" height="405px" alt="">
                </div>
              </div>
            @elseif ($article->title == 'Agriculture Sector, Industrial Era 4.0 And Society 5.0' )
        ...
        <div class="content-row row">
          @foreach ($articles as $article)
              @if ($article->title == 'The Evolution Of Agriculture' or $article->title == 'Digital Agriculture Strategy' )
              <div class="col-lg-6">
                <figure class="figure">
                    <a href=""><img src="{{Storage::url($article->image)}}" width="570px" class="figure-img img-fluid" alt="..."></a>
                  <figcaption class="figure-caption mt-3">
                    <a href="{{ route('detail', $article->slug)}}" class="mb-2">{{$article->title}}</a> 
                    <h6>{{$article->category->name}}</h6>
                  </figcaption>
                </figure>
              </div>
      ...
      <div class="container">
        <div class="row reveal">
          <div class="col-8 col-lg-6 m-0 d-block d-lg-none">
            <img src="{{asset('assets/pictures/Photo by Warren Wong on Unsplash.jpg')}}" width="540px" height="405px" alt="">
          </div>
          <div class="col-8 col-lg-6">
            <div class="feature-sub-content">
              <h6>Feature</h6>
        ...
        <div class="row mt-5 reveal">
          <div class="col-8 col-lg-6">
            <img src="{{asset('assets/pictures/Photo by Tony Pham on Unsplash.jpg')}}" width="540px" height="405px" alt="">
          </div>
          <div class="col-8 col-lg-6 d-flex justify-content-end">
            <div class="feature-sub-content p-1">
              <h6>Feature</h6>
        ...
        <div class="content-row row">
          <div class="col-lg-6">
            <figure class="figure">
                <a href=""><img src="{{asset('assets/pictures/Photo by Tomas Anunziata from Pexels - cropped.jpg')}}" width="570px" class="figure-img img-fluid" alt="..."></a>
              <figcaption class="figure-caption mt-3">
          ...
          <div class="col-lg-6">
            <figure class="figure">
              <a href=""><img src="{{asset('assets/pictures/Photo by Charles Deluvio on Unsplash - cropped.jpg')}}" width="570px" class="figure-img img-fluid" alt="..."></a> 
              <figcaption class="figure-caption mt-3">
